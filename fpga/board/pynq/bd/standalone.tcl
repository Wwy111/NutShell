...
proc create_hier_cell_rv_system { parentCell nameHier } {
  ...
  create_bd_intf_pin -mode Slave -vlnv xilinx.com:interface:aximm_rtl:1.0 io_frontend
  ...
  connect_bd_intf_net -intf_net axi_protocol_convert_0_M_AXI [get_bd_intf_pins NutShell_0/io_frontend] [get_bd_intf_pins axi_protocol_convert_0/M_AXI]
  ...
  connect_bd_net -net clk_wiz_0_coreclk [get_bd_pins coreclk] [get_bd_pins NutShell_0/clock] [get_bd_pins axi_protocol_convert_0/aclk] [get_bd_pins axi_protocol_convert_1/aclk] [get_bd_pins c_shift_ram_0/CLK] [get_bd_pins c_shift_ram_1/CLK] [get_bd_pins system_ila_0/clk]
...
proc create_root_design { parentCell } {
  ...
  # Create interface connections
  connect_bd_intf_net -intf_net NutShell_0_io_mem [get_bd_intf_pins axi_interconnect_0/S00_AXI] [get_bd_intf_pins rv_system/io_mem]
